# encoding: utf-8
"Stacking methods the prediction from Linear SVC meta classifier"
...
#Scale the prediction matrix from first layer
scaler = StandardScaler()
scaler.fit(secondLayerInput)
secondLayerInput = scaler.transform(secondLayerInput)

#Train the meta classifier
svm = LinearSVC(random_state=0)
svm.fit(secondLayerInput, labels)
